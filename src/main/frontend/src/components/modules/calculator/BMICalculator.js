...
const BMICalculator = () => {
    ...
    return (
        <div>
            <div className="bmi-calculator calculator-pattern">
                <h2 className="calculator-pattern__title">Bədən Kütlə İndeksi Hesablayıcı</h2>
            ...
            {resultsLoaded && 
                <div className="calculator-result">
                    <div className="calculator-result__inputs">
                        ...
                        <p className="calculator-result__inputs__info">{result.human.gender == 1 ? "Kişi" : "Qadın"}, {result.human.weight} kq, {result.human.height} sm</p>
                    </div>
                    <div className="row">
                        <div className="col-sm-4 col-xs-12">
                            <div className={'user-bmi-box '+( result.status ? 'green' : 'red' )+' calculator-result__box'}>
                                <p className="box__sub">Indeks</p>
                                <h3 className="box__title">{result.bmi} <small>kq</small></h3>
                            </div>
                        </div>
                    </div>
